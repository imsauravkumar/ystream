        ...
        <div className="overflow-hidden rounded-xl border border-zinc-800 bg-panel/90 shadow-glow">
          <div className="grid gap-5 p-5 sm:p-6 lg:grid-cols-[minmax(0,1fr)_16rem] lg:items-center">
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-950/80 p-4">
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-muted">Preview code</p>
              <p className="mt-2 text-3xl font-black tracking-[0.2em] text-white">{previewCode}</p>
              <Button className="mt-4 h-12 w-full px-5" disabled={busy || loading} type="button" onClick={handleCreate}>
